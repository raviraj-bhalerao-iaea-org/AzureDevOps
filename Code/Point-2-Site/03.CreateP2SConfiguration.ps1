...
$gateway.VpnClientConfiguration.VpnClientAddressPool = $addressSpace
...
$p2sConfigJob = Set-AzVirtualNetworkGateway -VirtualNetworkGateway $gateway -AsJob
Wait-ForJobs -Jobs @($p2sConfigJob) -DoNotRemoveJobs
Write-Host "P2S configuration created: $($vm.Name)"
